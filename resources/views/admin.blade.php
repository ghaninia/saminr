...
<html lang="{{ $meta['lang'] ?? 'en' }}" dir="{{ $meta['dir'] ?? 'ltr' }}">
    <head>
        ...
        <title>{{ $meta['title'] ?? 'Admin Dashboard' }}</title>
        ...
        <meta property="og:title" content="{{ $meta['title'] ?? 'Admin Dashboard' }}">
        <meta property="og:description" content="{{ $meta['description'] ?? '' }}">
        <meta property="og:url" content="{{ $meta['canonical'] ?? url()->current() }}">
        <meta property="og:site_name" content="{{ $meta['site_name'] ?? ($meta['title'] ?? 'Admin Dashboard') }}">
        <meta property="og:image" content="{{ $meta['image'] ?? '' }}">
        <meta property="og:locale" content="{{ $meta['locale'] ?? 'en_US' }}">

        <meta name="twitter:card" content="summary_large_image">
        <meta name="twitter:title" content="{{ $meta['title'] ?? 'Admin Dashboard' }}">
